...
function HeroSectionTitle() {
    return (
        <div className='flex flex-col justify-center items-center gap-4 px-8 sm:pt-12 overflow-hidden'>
            ...
            <button type="button" className="sm:mt-12 mt-0 py-3 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#3B34BE] text-white hover:bg-[#2D27A9] focus:outline-none focus:bg-[#2D27A9] disabled:opacity-50 disabled:pointer-events-none dark:bg-[#bbb9e4] dark:text-[#3B34BE] dark:hover:bg-[#aca9d8] dark:focus:bg-[#aca9d8]">
