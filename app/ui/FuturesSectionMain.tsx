        ...
        <div className='flex flex-col justify-center items-center gap-4 w-full max-w-6xl mx-auto mt-12'>
            ...
            <div className='grid md:grid-cols-3 grid-cols-1 justify-between items-center w-full gap-6 md:px-0 px-4'>
                <div className='flex flex-col justify-center items-center rounded-xl gap-4 dark:bg-[#111c2a] bg-[#f1f1f1] p-8 h-full'>
                    ...
                    <h1 className='md:text-lg text-lg font-bold'>{t("future-one-title")}</h1>
                ...
                <div className='flex flex-col justify-center items-center rounded-xl gap-4 dark:bg-[#111c2a] bg-[#f1f1f1] p-8 h-full'>
                    ...
                    <h1 className='md:text-lg text-lg font-bold'>{t("future-two-title")}</h1>
                ...
                <div className='flex flex-col justify-center items-center rounded-xl gap-4 dark:bg-[#111c2a] bg-[#f1f1f1] p-8 h-full'>
                    ...
                    <h1 className='md:text-lg text-lg font-bold'>{t("future-three-title")}</h1>
                ...
                <div className='flex flex-col justify-center items-center rounded-xl gap-4 dark:bg-[#111c2a] bg-[#f1f1f1] p-8 h-full'>
                    ...
                    <h1 className='md:text-lg text-lg font-bold'>{t("future-four-title")}</h1>
                ...
                <div className='flex flex-col justify-center items-center rounded-xl gap-4 dark:bg-[#111c2a] bg-[#f1f1f1] p-8 h-full'>
                    ...
                    <h1 className='md:text-lg text-lg font-bold'>{t("future-five-title")}</h1>
                ...
                <div className='flex flex-col justify-center items-center rounded-xl gap-4 dark:bg-[#111c2a] bg-[#f1f1f1] p-8 h-full'>
                    ...
                    <h1 className='md:text-lg text-lg font-bold'>{t("future-six-title")}</h1>
